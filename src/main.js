...
chinese['webSetting']['outLinkName'] = '弹窗时间'
...
chinese['adminLimit']['webSetting_outLinkName'] = '可否修改弹窗时间'
...
writeType['webSetting']['outLinkName'] = 'multiline' // '弹窗时间'
writeType['webSetting']['outLinkName_options'] = ["未登录弹窗（每隔几分钟）","未读消息弹窗（每隔几分钟）"]
...
writeType['adminLimit']['webSetting_outLinkName'] = '可否修改弹窗时间'
